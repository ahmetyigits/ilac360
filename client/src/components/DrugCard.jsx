...
const PRESCRIPTION_BADGE = {
  ...
  izleme: { label: 'Normal Reçete · İzlemeye Tabi', note: 'Normal (beyaz) reçete ile verilir ancak izlemeye tabidir (renkli reçete değildir).', cls: 'border border-amber-300 text-amber-700 dark:border-amber-700/50 dark:text-amber-300' },
