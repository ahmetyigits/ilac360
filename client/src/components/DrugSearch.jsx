      ...
      <div className="flex items-center gap-[13px] px-[18px] py-[15px] bg-card-inset rounded-[15px] border-[1.5px] border-accent/30 focus-within:border-accent/60 transition-colors">
        ...
        {isScanSupported() && (
          <button
            ...
            className="flex-none w-11 h-11 -my-1.5 rounded-[10px] text-accent hover:bg-accent-soft flex items-center justify-center transition-colors cursor-pointer disabled:opacity-40 disabled:cursor-not-allowed"
          >
